  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <header className="text-center mb-12">
        ...
        <p className="text-xl title">Discover the story behind our high-quality, customizable stainless steel bottles.</p>
      </header>

      <section className="mb-12">
        <h2 className="text-3xl font-semibold title mb-6">Nuestra Historia</h2>
        <p className="text-lg mb-6 title">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg mb-6">Nuestra misión es crear productos sostenibles que reflejen tu personalidad.</p>
        <div className="flex justify-around mt-6">
          <div className="text-center max-w-xs">
            <img src="ruta-a-icono-sostenibilidad.png" alt="Sostenibilidad" className="w-16 h-16 mx-auto mb-4" />
      ...
      <section className="mb-12">
        ...
        <div className="flex justify-center gap-8">
          ...
          <div className="max-w-sm p-6 bg-contrast rounded-lg shadow-md text-center">
            <p className="text-lg mb-4">"Una excelente opción para un regalo único y especial."</p>
      ...
      <section className="mb-12">
        ...
        <div className="flex justify-around">
          <div className="text-center">
            <img
              src="ruta-a-imagen-miembro-equipo1.jpg"
          ...
          <div className="text-center">
            <img
              src="ruta-a-imagen-miembro-equipo2.jpg"
